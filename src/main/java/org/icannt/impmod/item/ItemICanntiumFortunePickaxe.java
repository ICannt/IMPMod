...
public class ItemICanntiumFortunePickaxe extends ItemPickaxe
{
	private String type = "tool";
	private String name = "ICanntium_Fortune_Pickaxe";
	
	public ItemICanntiumFortunePickaxe(ToolMaterial enumToolMaterial)
	{
    ...
    {
		ItemStack newItem = new ItemStack(IMPItems.icanntiumFortunePickaxe, 1, 0);
		newItem.addEnchantment(Enchantment.fortune, 5);
		newItem.addEnchantment(Enchantment.efficiency, 7);
